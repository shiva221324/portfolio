...
const Resume = (props: Props) => {
  return (
    <div
      ...
      className=" hidden md:block cursor-pointer group dark:text-white text-black absolute left-[13rem] top-[64.4rem] md:fixed md:left-2 md:top-[44rem] lg:top-[40rem] w-[7.5rem] h-[2.74rem] md:w-[7rem] md:h-[2.2rem] rounded-lg"
    >
      <a
        href={`${resume}`}
