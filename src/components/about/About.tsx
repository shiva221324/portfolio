...
const About = ({ isDark }: Props) => {
  return (
    <section id="about" className=" mt-[40rem]">
      <div
        // className="  absolute top-[43rem] left-[4rem] md:left-[8rem] w-[86%] dark:text-white text-black dark:bg-black  "
        className=" mt-24 lg:mt-44 mb-5 ml-[3.9rem]  md:ml-20 dark:text-white text-black  "
      >
        <motion.div
...
ntinuous learning.`}
            ...
            <div className=" hidden  mt-5 md:flex md:flex-col text-sm lg:text-lg md:leading-6 lg:leading-8">
              ...
              <p>
                and back-end development. With a strong foundation in data
                structures
              </p>
              <p>
                and algorithms, I enjoy creating efficient and dynamic web
                applications.
              </p>
              <p>
        ...
        <div className=" flex flex-col gap-5 ">
          <p>
            <span>School</span>Sri Chaitanya School
          </p>
          <p>
            <span>Intermediate</span>Sri Chaitanya college
          </p>
          <p>
            <span>Btech</span>Lakireddy Balireddy college
          </p>
        </div>
      </div> */}
      </div>
